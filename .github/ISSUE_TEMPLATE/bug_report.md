...
<!--
Thank you for reporting a possible bug in UCF-Location-CPT-Plugin.
...
The version of this plugin can be found by clicking "Plugins" in the Admin navigation and finding "UCF Location Custom Post Type" in the list of plugins. The version number will be listed under the plugin description.
-->
